...
age_grid = linspace(min(ages), max(ages), 50);  % 30 points for smoothness
...
%% Marginalization 
% Define age group edges (0-20, 20-40, ..., 80-100)
age_group_edges = 0:20:100;
...
age_intervals = 0:20:100;  % Adjust as needed
