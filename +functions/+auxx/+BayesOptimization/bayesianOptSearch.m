...
% Define the objective function to be minimized using Bayesian Optimization
    ...
    l1_domain = optimizableVariable('l1', [10^(-4), lambda_space(1)], 'Transform', 'log'); % s
    l2_domain = optimizableVariable('l2', [10^(-4), lambda_space(2)], 'Transform', 'log'); % e
    l3_domain = optimizableVariable('l3', [10^(-4), lambda_space(3)], 'Transform', 'log'); % a
