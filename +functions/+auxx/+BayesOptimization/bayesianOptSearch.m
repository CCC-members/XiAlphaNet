...
%
    ...
    l1_domain = optimizableVariable('l1', [1e-4, lambda_space(1)], 'Transform', 'log');
    l2_domain = optimizableVariable('l2', [1e-4, lambda_space(2)], 'Transform', 'log');
    l3_domain = optimizableVariable('l3', [1e-4, lambda_space(3)], 'Transform', 'log');
