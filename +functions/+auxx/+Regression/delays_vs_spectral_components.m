...
ax = gca;
set(ax, 'color', 'white');    % Axes background white
set(ax, 'FontSize', 14);      % Tick labels font size 12
set(ax, 'FontWeight', 'bold');% Tick labels bold
