classdef circularGraphV < handle
...
% Copyright 2016 The MathWorks, Inc.
  ...
  methods
    function this = circularGraph(adjacencyMatrix,varargin)
      ...
      set(fig,...
        'UserData',this,...
        'CloseRequestFcn',@circularGraphV.CloseRequestFcn);
      ...
      for i = 1:length(adjacencyMatrix)
        this.Node(i) = nodeV(cos(t(i)),sin(t(i)));
